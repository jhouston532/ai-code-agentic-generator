...
```
This script will read a list of integers from stdin (one per line), compute their sum and mean, then print both values in the format shown in EXPECTED_OUTPUT. It also handles the case where the input list is empty by printing "Sum: 0" and "Average: 0.00".
